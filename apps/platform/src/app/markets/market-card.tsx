...
import { MarketLink } from '@/app/dashboard/market-link'
...
export function MarketCard({ market }: { market: MarketSnapshot }) {
  ...
  return (
    <div className="flex flex-col rounded-lg bg-stone-950/80 ring-1 ring-stone-800 p-5 hover:ring-emerald-400/40 transition">
      <MarketLink market={market} className="block group cursor-pointer">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            ...
            <div className="text-sm font-semibold text-white leading-snug line-clamp-3 group-hover:text-emerald-300 transition">
              {market.question}
            </div>
          </div>
          <span
