...
export function UpcomingResolutions({ markets }: { markets: MarketSnapshot[] }) {
  return (
    <div className="rounded border border-stone-200 bg-white">
      ...
      <div className="px-4 py-2">
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-3 text-[10px] text-stone-400 tracking-wider pb-2 border-b border-stone-100">
          <div>DATE</div>
          <div>MARKET</div>
          ...
          markets.map((m) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-xs font-semibold text-emerald-600 tabular-nums text-right">
